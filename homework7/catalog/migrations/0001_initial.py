    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(
                    help_text="An author's full name",
                    max_length=100
                )),

                ('date_of_birth', models.DateField(null=True)),
                ('date_of_death', models.DateField(
                    "A date of author's death (or Null, if alive or unknown).",
                    null=True
                )),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'name',
                    models.CharField(help_text='A book genre',
                    max_length=100
                )
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status',
                    models.CharField(choices=[('o', 'On loan'), ('a', 'Available'), ('r', 'Reserved')],
